...
export const WATCH_UNDERLYINGS = ["NVDA", "SPCX", "TSLA", "AAPL", "GOOGL", "META", "MSFT", "MU", "ASTS", "SKHY", "SNDK", "QQQ", "SLV", "GLD"] as const;
...
export interface Signal {
  ...
  setup: "opening_range" | "trend_continuation" | "scalp_reclaim" | "opening_drive" | "none"; confidence: number; reasons: string[]; invalidation: string | null;
